...
export default function TeacherSurveyTakePage() {
  ...
  if (submitted) return <Result status="success" title="Survey Submitted!" subTitle="Thank you for your response." extra={<Button type="primary" onClick={() => navigate('/teacher/surveys')}>Back to Surveys</Button>} />;
  if (!survey) return <Result status="404" title="Survey Not Found" extra={<Button onClick={() => navigate('/teacher/surveys')}>Back</Button>} />;
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginTop: 24 }}>
        <Space>
          <Button onClick={() => navigate('/teacher/surveys')}>Cancel</Button>
