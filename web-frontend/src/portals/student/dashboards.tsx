...
import { FundProjectionScreenOutlined, EyeOutlined } from '@ant-design/icons';
  ...
  return (
    <div>
      <div style={{ marginBottom: 28 }}>
        <Title level={3} style={{ marginBottom: 4, color: token.colorText, fontWeight: 700 }}>Public Dashboards</Title>
        <Text style={{ color: token.colorTextSecondary }}>Explore data visualizations published by the observatory</Text>
      </div>
      ...
      <Spin spinning={loading}>
        {dashboards.length > 0 ? (
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
                    <div style={{
                      ...
                      <FundProjectionScreenOutlined style={{ fontSize: 18 }} />
                    </div>
                    <div style={{ flex: 1 }}>
                  ...
                  <div style={{ marginTop: 'auto' }}>
                    <Button
                      ...
                      size="small"
                      icon={<EyeOutlined />}
                      onClick={() => navigate(`/public/dashboards/${dashboard.slug}`)}
                    >
                      View Dashboard
                    </Button>
                  </div>
          ...
          <Empty description="No public dashboards available" style={{ padding: 60 }} />
        )}
      </Spin>
    </div>
  );
