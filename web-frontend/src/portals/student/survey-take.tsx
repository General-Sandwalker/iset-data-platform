...
import { Card, Typography, Button, Input, Select, Rate, Checkbox, DatePicker, InputNumber, Space, Spin, message, theme, Result, Form, Tag } from 'antd';
...
export default function StudentSurveyTakePage() {
  ...
  if (submitted) return <Result status="success" title="Survey Submitted!" subTitle="Thank you for your response." extra={<Button type="primary" onClick={() => navigate('/student/surveys')}>Back to Surveys</Button>} />;
  if (!survey) return <Result status="404" title="Survey Not Found" extra={<Button onClick={() => navigate('/student/surveys')}>Back</Button>} />;
  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginTop: 24 }}>
        <Space>
          <Button onClick={() => navigate('/student/surveys')}>Cancel</Button>
