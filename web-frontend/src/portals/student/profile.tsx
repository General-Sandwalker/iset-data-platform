...
import { Card, Typography, Form, Input, Button, Row, Col, Spin, message, Divider, theme } from 'antd';
  ...
  return (
    <div>
      ...
      <Row gutter={[24, 24]}>
        <Col xs={24} lg={14}>
          <Card
            title={<span><UserOutlined style={{ marginRight: 8 }} />Personal Information</span>}
