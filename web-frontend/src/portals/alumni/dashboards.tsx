...
export default function AlumniDashboardsPage() {
  ...
  return (
    <div>
      <div style={{ marginBottom: 28 }}>
        <Title level={3} style={{ marginBottom: 4, color: token.colorText, fontWeight: 700 }}>Insertion Statistics</Title>
        <Text style={{ color: token.colorTextSecondary }}>Explore career insertion data and professional outcomes</Text>
      </div>
      ...
      <Spin spinning={loading}>
        {dashboards.length > 0 ? (
          ...
          <Empty description="No insertion dashboards available" style={{ padding: 60 }} />
        )}
      </Spin>
    </div>
  );
